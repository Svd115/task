						...
						function signup(psw){
							...
							get_signup.on('return', function(data){
								if(data[0]){
									...
									var content = 
									"<p>In order to validate your account please click on this link : </p><a href='"+req.protocol+'://'+req.hostname+"/signup/"+data[1]+"/"+data[2]+"' rel='nofollow'>Confirm my account</a>";
